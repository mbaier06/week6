...
async function renderPost(postInputID, postUsername, postImageUrl, postNumberOfLikes) {
...
window.addEventListener('DOMContentLoaded', async function(event) {
  ...
  for (let i = 0; i < postInputs.length; i++) {
    ...
    let postNumberOfLikes = postInputData.likes
